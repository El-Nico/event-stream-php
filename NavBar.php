      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php 
          ...
          if(isset($_SESSION) && isset($_SESSION['id'])){
            ...
            echo '<a class="nav-link active" aria-current="page" href="NewBook.php">New Book</a>';
            echo '</li>';
            echo '<li class="nav-item">';
            echo '<a class="nav-link active" aria-current="page" href="PublisherList.php">Publisher List</a>';
            echo '</li>';
